  ...
  switch (variant) {
      ...
      return (
        <>
          <Link
            ...
            to={link}
          >
            <Typography variant={"button"} color="neutral-1" bold={true}>
              {text}
            </Typography>
          </Link>
        </>
      ...
      return (
        <>
          <Link
            ...
            to={link}
          >
            <button className="group relative cursor-default w-[240px] h-[60px] bg-[linear-gradient(144deg,_#af40ff,_#5b42f3_50%,_#00ddeb)] text-neutral-1-color whitespace-nowrap flex flex-wrap rounded-lg overflow-hidden">
    ...
    case "2":
      return (
        <>
          <Link
            className="flex flex-row justify-center items-center bg-transparent scale-150 py-2 px-4 transition"
            to={link}
          >
